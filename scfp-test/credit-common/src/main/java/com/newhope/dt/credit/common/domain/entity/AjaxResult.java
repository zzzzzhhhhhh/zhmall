package com.newhope.dt.phdb.common.domain.entity;
...
public class AjaxResult extends HashMap<String, Object> {
     ...
     * 返回内容
     */
    public static final String MSG_TAG = "errMessage";
    /**
     * 数据对象
     */
     ...
     * @param data 数据对象
     */
    public AjaxResult(int code, String msg, Object data,boolean isSuccess) {
        super.put(CODE_TAG, code);
        super.put(MSG_TAG, msg);
    ...
    public static AjaxResult error(String msg, Object data) {
        return new AjaxResult(HttpStatus.ERROR, msg, data,false);
    }
